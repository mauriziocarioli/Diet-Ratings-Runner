...
public class CalculateTest5 {
	...
	public void testRunDrools() {
	    ...
	    assertTrue(item[0].getRatings().getPointsBreakup().get(0).getPoints() == 0.);
	    
	    assertTrue(item[0].getRatings().getPointsBreakup().get(1).getPoints() == -3.);
